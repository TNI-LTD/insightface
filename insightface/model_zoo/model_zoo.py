...
class ModelRouter:
    ...
    def get_model(self, **kwargs):
        ...
        print(
            f'Applied providers: {session._providers}, '
            f'with options: {session._provider_options}')
...
def get_model(name, **kwargs):
    ...
    model = router.get_model(providers=kwargs.get(
        'providers'), provider_options=kwargs.get('provider_options'))
    return model
